...
class PatientRecordTest(TestCase):
    def test_create_record(self):
        ...
        p_record.create_note("Patient reports disapearance of headaches")
        self.assertNotEqual(p_record, p_record2, "Non empty list should not equal empty list")
        p_record2.create_note("Patient comes with headaches and elevated blood pressure")
    ...
    def test_delete_note(self):
        ...
        p_record.create_note("Patient enters with elevated BP")
        ...
        p_record.create_note("Patient comes with headaches and elevated blood pressure")
        p_record.create_note("Patient headaches worsening, describes a progression towards migranes")
